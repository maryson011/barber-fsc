                    ...
                    <SheetFooter className="flex-row gap-3 mt-6">
                        ...
                        <AlertDialog>
                            <AlertDialogTrigger asChild>
                                <Button  
                                    disabled={!isBookingConfirmed || isDeleteLoading} className="w-full" 
                                    variant="destructive">
                                    Cancelar Reserva
                                </Button>
                            </AlertDialogTrigger>
                            <AlertDialogContent className="w-[90%]">
                                <AlertDialogHeader>
                                    <AlertDialogTitle>Deseja cancelar essa reserva?</AlertDialogTitle>
                                ...
                                <AlertDialogFooter className="flex-row gap-3">
                                    ...
                                    <AlertDialogAction disabled={isDeleteLoading} className="w-full" 
